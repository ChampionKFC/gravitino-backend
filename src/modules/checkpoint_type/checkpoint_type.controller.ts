...
import { StatusCheckpointTypeResponse } from './response';
...
export class CheckpointTypeController {
  ...
  @Post()
  create(
    @Body() createCheckpointTypeDto: CreateCheckpointTypeDto,
    @Req() request,
  ) {
    return this.checkpointTypeService.create(
  ...
  @Patch()
  update(
    @Body() updateCheckpointTypeDto: UpdateCheckpointTypeDto,
    @Req() request,
  ) {
    return this.checkpointTypeService.update(
