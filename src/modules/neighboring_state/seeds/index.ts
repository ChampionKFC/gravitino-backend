...
export class NeighboringStateSeeds implements OnSeederInit {
  run() {
    const data = [
      { neighboring_state_name: 'Китай' },
      { neighboring_state_name: 'Монголия' },
      { neighboring_state_name: 'Казахстан' },
      { neighboring_state_name: 'Грузия' },
      { neighboring_state_name: 'Абхазия' },
    ]
    return data
  }
}
